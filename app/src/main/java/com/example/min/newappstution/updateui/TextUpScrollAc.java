 ...
 * 经典下拉
 */
public class TextUpScrollAc extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.up_src_layout);
    ...
    private void setInfo(@Nullable List<String> stringList){
        commonRecyclerAdapter=new CommonRecyclerAdapter<String>(TextUpScrollAc.this,R.layout.item_up_layout,
                stringList) {
            @Override
